...
HD_PWD='C:/Users/CPEG202/Desktop/zybo-stuff/Lab10Part2/Lab10Part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log increment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source increment.tcl
