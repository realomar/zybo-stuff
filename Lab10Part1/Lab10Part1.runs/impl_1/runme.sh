...
HD_PWD='C:/Users/CPEG202/Desktop/zybo-stuff/Lab10Part1/Lab10Part1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log increment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source increment.tcl -notrace
