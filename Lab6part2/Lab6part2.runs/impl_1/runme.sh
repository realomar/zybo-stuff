...
HD_PWD='C:/Users/CPEG202/Desktop/Lab6part2/Lab6part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Problem2.tcl -notrace
