...
HD_PWD='C:/Users/CPEG202/Desktop/Lab6part2/Lab6part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Problem2.tcl
